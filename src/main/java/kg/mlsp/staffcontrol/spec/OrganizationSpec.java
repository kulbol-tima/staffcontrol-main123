...
public class OrganizationSpec {
    public static Specification<Organization> hasNameRu(String nameRu) {
    ...
    public static Specification<Organization> hasNameKy(String nameKy) {
        return (root, query, criteriaBuilder) -> {
    ...
    public static Specification<Organization> hasPin(String pin) {
        return (root, query, criteriaBuilder) -> {
            if (pin == null || pin.isBlank()) {
                return criteriaBuilder.conjunction();
            }
            return criteriaBuilder.like(criteriaBuilder.lower(root.get("pin")), "%" + pin.toLowerCase() + "%");
        };
    }

    public static Specification<Organization> hasIsActive(Boolean isActive) {
        return (root, query, criteriaBuilder) -> {
            if (isActive == null) {
                return criteriaBuilder.conjunction();
            }
    ...
    public static Specification<Organization> hasCreatedAtFrom(LocalDateTime createdAtFrom) {
        return (root, query, criteriaBuilder) -> {
    ...
    public static Specification<Organization> hasCreatedAtTo(LocalDateTime createdAtTo) {
        return (root, query, criteriaBuilder) -> {
            if (createdAtTo == null) {
                return criteriaBuilder.conjunction();
            }
    ...
    public static Specification<Organization> hasUpdatedAtFrom(LocalDateTime updatedAtFrom) {
        return (root, query, criteriaBuilder) -> {
    ...
    public static Specification<Organization> hasUpdatedAtTo(LocalDateTime updatedAtTo) {
        return (root, query, criteriaBuilder) -> {
            if (updatedAtTo == null) {
                return criteriaBuilder.conjunction();
            }
