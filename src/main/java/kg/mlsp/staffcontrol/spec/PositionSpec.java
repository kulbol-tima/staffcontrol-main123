...
public class PositionSpec {
    public static Specification<Position> hasNameRu(String nameRu) {
    ...
    public static Specification<Position> hasNameKy(String nameKy) {
        return (root, query, criteriaBuilder) -> {
    ...
    public static Specification<Position> hasIsActive(Boolean isActive) {
        return (root, query, criteriaBuilder) -> {
            if (isActive == null) {
                return criteriaBuilder.conjunction();
            }
    ...
    public static Specification<Position> hasCode(String code) {
        return (root, query, criteriaBuilder) -> {
    ...
    public static Specification<Position> hasCreatedAtFrom(LocalDateTime createdAtFrom) {
        return (root, query, criteriaBuilder) -> {
    ...
    public static Specification<Position> hasCreatedAtTo(LocalDateTime createdAtTo) {
        return (root, query, criteriaBuilder) -> {
            if (createdAtTo == null) {
                return criteriaBuilder.conjunction();
            }
    ...
    public static Specification<Position> hasUpdatedAtFrom(LocalDateTime updatedAtFrom) {
        return (root, query, criteriaBuilder) -> {
    ...
    public static Specification<Position> hasUpdatedAtTo(LocalDateTime updatedAtTo) {
        return (root, query, criteriaBuilder) -> {
            if (updatedAtTo == null) {
                return criteriaBuilder.conjunction();
            }
